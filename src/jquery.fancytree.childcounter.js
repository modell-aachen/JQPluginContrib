...
var getAttachCount = function(node) {
  if ( node === null || typeof node === typeof undefined ) {
    return 0;
  }

  if ( node.data && node.data.isAttachment ) {
    return 1;
  }
